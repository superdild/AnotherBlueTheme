package substratum.theme.AnotherBlueTheme;
...
import static substratum.theme.AnotherBlueTheme.ThemerConstants.APK_SIGNATURE_PRODUCTION;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.BASE_64_LICENSE_KEY;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.BLACKLISTED_APPLICATIONS;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.ENABLE_BLACKLISTED_APPLICATIONS;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.ENFORCE_INTERNET_CHECK;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.PIRACY_CHECK;
import static substratum.theme.AnotherBlueTheme.ThemerConstants.THEME_READY_GOOGLE_APPS;
